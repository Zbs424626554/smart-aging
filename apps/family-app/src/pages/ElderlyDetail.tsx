...
const ElderlyDetail: React.FC = () => {
  ...
  return (
    <div>
      {/* 导航栏 */}
      <NavBar
        style={{position: "sticky", top: 0, backgroundColor: "#0077C2",color:'white',fontWeight:'600',height:'60px' }}
        onBack={() => navigate(-1)}
      >
        老人详情
      </NavBar>
      <div className={styles.elderlyDetail}>
          ...
          <div className={styles.infoGrid}>
            ...
            <div className={styles.infoItem}>
              ...
              <span className={styles.infoValue}>
                {formatDate(elderly.createdTime)}
              </span>
            </div>
          </div>
        </Card>
        ...
        <Card className={styles.basicInfoCard}>
          ...
          <div className={styles.infoGrid}>
            ...
            <div className={styles.infoItem}>
              ...
              <span className={styles.infoValue}>
                {elderly.height || "170"}cm
              </span>
            </div>
            <div className={styles.infoItem}>
              <span className={styles.infoLabel}>体重</span>
              <span className={styles.infoValue}>
                {elderly.weight || "65"}kg
              </span>
            </div>
            <div className={styles.infoItem}>
        ...
        <Card className={styles.medicationsCard}>
          ...
          <div className={styles.medicationList}>
            {(elderly.medications || ["阿司匹林", "钙片", "维生素D"]).map(
              (medication, index) => (
        ...
        <Card className={styles.historyCard}>
          ...
          <div className={styles.historyList}>
            {(elderly.medicalHistory || ["高血压", "糖尿病", "骨质疏松"]).map(
              (history, index) => (
